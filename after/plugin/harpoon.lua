...
vim.keymap.set("n", "<leader>cund", function() 
    term.gotoTerminal(1) 
    term.sendCommand(1, "ntgd -p +cund\n") 
end)

vim.keymap.set("n", "<leader>cda", function() 
    term.gotoTerminal(1) 
    term.sendCommand(1, "ntgd -p +cda\n") 
end)

vim.keymap.set("n", "<leader>cind", function() 
    term.gotoTerminal(1) 
    term.sendCommand(1, "ntgd -p +cind\n") 
end)

vim.keymap.set("n", "<leader>dcu", function() 
    term.gotoTerminal(1) 
    term.sendCommand(1, "ntgd +dcu -d\n") 
end)

vim.keymap.set("n", "<leader>dcd", function() 
    term.gotoTerminal(1) 
    term.sendCommand(1, "ntgd +dcd\n") 
end)

vim.keymap.set("n", "<leader>cc", function() 
    term.gotoTerminal(1) 
    term.sendCommand(1, "ntgd -cc\n") 
